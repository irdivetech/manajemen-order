            ...
            <div class="col-md-8">
                <div class="row g-2">
                    ...
                    <div class="col-4">
                        ...
                        <input type="hidden" id="old_province" value="{{ old('customer_province', $order->customer_province) }}">
                    ...
                    <div class="col-4">
                        ...
                        <input type="hidden" id="old_city" value="{{ old('customer_city', $order->customer_city) }}">
                    ...
                    <div class="col-4">
                        ...
                        <input type="hidden" id="old_district" value="{{ old('customer_district', $order->customer_district) }}">
